              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative group/input">
                  ...
                  <input
                    ...
                    className={`w-full bg-[#111111]/80 border rounded-xl pl-11 pr-4 py-3.5 text-white placeholder-slate-600 focus:outline-none focus:bg-[#151515] transition-all text-sm shadow-inner ${
                      errors?.shop ? "border-red-500/50 focus:border-red-500 focus:ring-1 focus:ring-red-500" : "border-white/10 focus:border-[#e13a9d]/50 focus:ring-1 focus:ring-[#e13a9d]/50"
                    }`}
                    required
                  />
                </div>
