            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-[#111111] border rounded-lg px-4 py-3.5 text-white placeholder-slate-600 focus:outline-none transition-all text-base ${
                    errors?.shop ? "border-red-500/50 focus:border-red-500 focus:ring-1 focus:ring-red-500" : "border-white/10 focus:border-purple-500 focus:ring-1 focus:ring-purple-500"
                  }`}
                  required
                />
              </div>
              {errors?.shop && (
                <p className="mt-1 text-sm text-red-400">{errors.shop}</p>
              )}
            </div>
