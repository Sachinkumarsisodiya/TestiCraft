            ...
            <Form method="post" className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className={`w-full bg-[#161616] border rounded-lg px-4 py-3 text-white placeholder-slate-600 focus:outline-none transition-all text-sm shadow-inner ${
                    errors?.shop ? "border-red-500 focus:border-red-500 focus:ring-1 focus:ring-red-500" : "border-[#222] focus:border-[#a855f7] focus:ring-1 focus:ring-[#a855f7]"
                  }`}
                  required
                />
                {errors?.shop && (
                  <p className="text-sm text-red-500 mt-1">{errors.shop}</p>
                )}
              </div>
